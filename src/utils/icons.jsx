...
export const IconFilm = ({ className = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const IconUnMark = ({ className = "h-6 w-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const IconPin = ({ className = "h-6 w-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const IconMail = ({ className = "h-6 w-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const IconCalender = ({ className = "h-6 w-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const IconReplay = ({ className = "h-6 w-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const IconQuote = ({ className = "h-6 w-6 " }) => {
  return (
...
export const IconHeartFill = ({ className = "h-6 w-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <g id="Layer_1">
        <g>
          ...
          />
          <path className="st7" d="M445.1,683.6h-39.5" />
          <path className="st7" d="M484.2,683.6" />
          <path className="st7" d="M557.1,683.6" />
          <path className="st7" d="M621.8,683.6" />
        </g>
        <g>
          <path
            className="st7"
