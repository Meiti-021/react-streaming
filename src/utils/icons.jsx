...
export const IconHeart = ({ className = "h-5 w-5" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`${className}`}
...
export const IconShare = ({ className = "h-5 w-5" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`${className}`}
...
export const IconLink = ({ className = "h-5 w-5" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`${className}`}
...
export const IconLock = ({ className = "h-6 w-6 text-green-500" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
